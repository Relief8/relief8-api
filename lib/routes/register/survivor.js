...
module.exports = function* () {
    ...
    var medication = this.request.body.medication;
    var bloodType = this.request.body.bloodType;
    var phoneNumber = this.request.body.phoneNumber;
    var petCount = this.request.body.petCount;
    var specialNeeds = this.request.body.specialNeeds;
    var emergencyContact = this.request.body.emergencyContact;
    var preExistingConditions = this.request.body.preExistingConditions;
